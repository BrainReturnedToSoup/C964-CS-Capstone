...
def test_validate_constructor_args():
    ...
    mcp=MonteCarlo(logger=logger, predicter=predicter, seed=valid_seed, noise_std=valid_noise_std, num_of_samples_min=valid_num_of_samples_min, num_of_samples_max=valid_num_of_samples_max)
...
def test_create_noisy_input():
    ...
    mcp=MonteCarlo(logger=logger, predicter=predicter, seed=valid_seed, noise_std=valid_noise_std, num_of_samples_min=valid_num_of_samples_min, num_of_samples_max=num_of_samples)
